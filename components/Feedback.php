...
namespace Specialist\Feedback\Components;
...
class Feedback extends ComponentBase
{
    ...
    {
        return [
            'name'        => Lang::get('specialist.feedback::lang.component.feedback.name'),
            'description' => Lang::get('specialist.feedback::lang.component.feedback.description')
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'channelCode' => [
                'title' => Lang::get('specialist.feedback::lang.channel.one'),
                'description' => Lang::get('specialist.feedback::lang.component.feedback.channelCode.description'),
                'type' => 'dropdown',
                'required' => true
            ],
            'successMessage' => [
                'title' => Lang::get('specialist.feedback::lang.component.feedback.successMessage.title'),
                'description' => Lang::get('specialist.feedback::lang.component.feedback.successMessage.description')
            ],
            'redirectTo' => [
                'title' => Lang::get('specialist.feedback::lang.component.feedback.redirectTo.title'),
                'description' => Lang::get('specialist.feedback::lang.component.feedback.redirectTo.description'),
                'type' => 'dropdown',
                'default' => 0
            ]
        ];
    ...
    public function onSend()
    {
        try {
            ...
            $message = $this->property('successMessage', Lang::get('specialist.feedback::lang.component.onSend.success'));
